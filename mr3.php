...
"
    ...
    ║║║║║║╚╗║║║║║
    ╚═╩═╝╚═╝╚╩═╩╝
    ─────────────S̫̫e̫̫p̫̫a̫̫m̫̫e̫̫r̫̫
 

                  
";

echo $G."\n========[]WARCEU CYBER MUSLIM SPAMER[]========".$X."\n";
echo  $YY. $B."\n::###############################################";
echo $R."\n::############[WELCOME:MY:HOME]########################";
echo $YY."\n::#:                                                 #";
echo $BB."\n::#:Penutor ::[Author:or:MR.3]                       #";
echo $RR."\n::#:Github  ::[http://github.com/Mamang-hack:]       #";
echo $R."\n::#:Facebook ::[Author:or:Wong Kang Edzan:]           #";
echo $G."\n::#:YouTube  ::[https://youtoob.com/c/Warceu Cyber:]  #";                 
...
if(is_numeric($argv[1])) {
	...
	while(1) {
		echo "[]WCM Sending Massage... To[] # ".$G.$argv[1].$X."\n";	
...
while(1) {
foreach($argv[1] as $argv[2]):
echo "[]WCM Sending Massage... To[] # ".$G.$argv[2].$X."\n";
